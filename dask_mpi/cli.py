...
@click.option('--scheduler-port', default=0, type=int,
...
@click.option('--protocol', type=str, default="tcp",
              help="Network protocol to use like TCP")
...
def main(scheduler_file, interface, nthreads, local_directory, memory_limit,
         scheduler, dashboard_address,
         nanny, scheduler_port, protocol):
